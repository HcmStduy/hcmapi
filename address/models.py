...
class AddressModel(YGBaseModel):
    ...
    user = models.ForeignKey('user.AppUser', on_delete=models.CASCADE, verbose_name='用户',
...
class DiscountModel(YGBaseModel):
    user_id = models.ForeignKey('user.AppUser', on_delete=models.CASCADE, verbose_name='用户',
    ...
    time_of_validity = models.CharField(verbose_name='有效时间', max_length=20)
